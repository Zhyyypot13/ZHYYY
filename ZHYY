...
zteText.Text = "ZHY SCRIPT" -- Changed text
...
task.spawn(function()
    ...
    -- Phase 2: "ZHY SCRIPTS" comes from right to middle (quick and fast)
    ...
    -- Phase 3: Moon and "ZHY SCRIPTS" move off-screen, background fades
    ...
    -- "ZHY SCRIPT" goes right off-screen
    ...
    discordText.Size = UDim2.new(1, 0
